...
export class TmdbService {
  ...
  private bearerToken =
    'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlNTg5NzRkZTNkOWVkYzZiZjBjYmE3ZGYzODk1OTAxNyIsIm5iZiI6MTczNDI0NDkwNy43MzgsInN1YiI6IjY3NWU3YTJiNDg5ZGNiYWEwNmI2ZWNlNSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.lohZATptdP-yh4X9ACeHr9PrFNY02RWMoDxX70b0IIw';
  private fetchTrendMovie$: WritableSignal<
  ...
  getHeaders(): HttpHeaders {
    return new HttpHeaders().set('Authorization', `Bearer ${this.bearerToken}`);
  }
